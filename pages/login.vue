  ...
  <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-studio-charcoal">
    <div class="max-w-md w-full">
      <div class="text-center mb-8">
        ...
        <h1 class="font-display text-4xl text-ivory mb-2 tracking-wide">Welcome Back</h1>
        <p class="text-smoke">Sign in to your account to continue</p>
      </div>
      ...
      <div class="border border-primary/25 rounded-xl p-8 bg-studio-slate shadow-lg">
        ...
        <div class="mt-6 space-y-3 text-center">
          <p class="text-sm text-smoke">
            AI Film Studio is invite-only. Ask your administrator for an account.
          </p>
          <p class="text-sm text-smoke">
