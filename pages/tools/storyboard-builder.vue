<template>
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
    <div class="mb-8">
      <h1 class="font-display text-3xl sm:text-4xl text-ivory tracking-wide mb-2">Storyboard Builder</h1>
    ...
    <ClientOnly>
      ...
      <template v-else>
        <div class="rounded-xl border border-gray-200 bg-studio-slate p-5 sm:p-6 mb-8">
