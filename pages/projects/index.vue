<template>
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8 sm:mb-10">
      <div>
        <h1 class="font-display text-3xl sm:text-4xl text-ivory tracking-wide mb-2">Projects</h1>
    ...
    <ul v-else class="grid gap-4 sm:grid-cols-2">
      <li v-for="p in projects" :key="p.id">
        <NuxtLink
          ...
          class="block rounded-xl border border-gray-200 bg-studio-slate shadow-sm hover:border-primary/50 hover:bg-gray-50 transition-all p-5 h-full"
        >
