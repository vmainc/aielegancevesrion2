        ...
        >
          ...
          <div class="relative z-10 grid lg:grid-cols-12 gap-0 lg:gap-0">
            ...
            >
              ...
              <div
                v-if="!embedded && (linkedBibleEntity || castAssetCount > 0)"
              ...
              >
                ...
                >
                  Linked:
                  <NuxtLink
                    :to="`/projects/${projectId}/bible?entity=${linkedBibleEntity.id}`"
...
const emit = defineEmits<{
  'character-loaded': [payload: { characterId: string; name: string }]
  'character-saved': [payload: { characterId: string; name: string }]
}>()
...
const nameHint = computed(() => props.nameHint || '')
